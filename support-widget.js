(function() {
  ...
  style.textContent = `
    ...
    @media (max-width:600px) { #hw-bubble { bottom:130px !important; right:16px !important; } #hw-widget { bottom:194px !important; right:16px !important; max-width:calc(100vw - 32px) !important; } }
